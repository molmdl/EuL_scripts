...
def report_torsions(xp, label):
    ...
    ring_defs = [
        ('T1 N4 -C14-C17-N5 ', 4, 14, 17, 5),
        ('T2 N5 -C20-C23-N6 ', 5, 20, 23, 6),
        ('T3 N6 -C26-C29-N7 ', 6, 26, 29, 7),
        ('T4 N7 -C32-C87-N4 ', 7, 32, 87, 4),
        ('Tc N7 -C82-C90-N107 ', 7, 82, 90, 107),
    ]
...
STEREOCENTRES = [
    ...
    (71, 86, 112, [113, 114, 115], 72, 12),
    (55, 56, 116, [117, 118, 119], 57, 10),
    (39, 40, 120, [121, 122, 123], 41, 8),
]
