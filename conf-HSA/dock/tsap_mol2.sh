...
for i in sssD sssL rrrD rrrL ; do
       ...
       python ../scripts/dock/gro_itp_to_mol2.py --gro ../solv_md/me_${i}_tsap/me_${i}_tsap.gro --itp ../solv_md/me_${i}_tsap/me_${i}_tsap.itp --out me_${i}_tsap/me_${i}_tsap.mol2 
done
