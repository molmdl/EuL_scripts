...
cd ..
cd ibp_r_rec1
gnina -r ../rec1.pdb -l ibp_r.mol2 --autobox_ligand ../ref.pdb --autobox_add 12 --exhaustiveness 100 --num_modes 100 --addH off --stripH off --cpu 16 -o rec1-dzp.sdf --min_rmsd_filter 3 --scoring ad4_scoring --log rec1-ibp.log 2>/dev/null
cd ..
