#!/bin/bash
#SBATCH --job-name=fm7_AGP2_1.5us
#SBATCH --nodes=1            
#SBATCH --ntasks=1
...
i=$1
echo
gmx mdrun -deffnm fm_1500ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm7_ext.dat  -cpi fm_1200ns_${i}.cpt -noappend
