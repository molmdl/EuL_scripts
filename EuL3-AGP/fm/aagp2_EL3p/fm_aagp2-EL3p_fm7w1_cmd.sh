#!/bin/bash
#SBATCH --job-name=fm7w1_AGP2_1us
#SBATCH --nodes=1            
#SBATCH --ntasks=1
...
gmx mdrun -deffnm pr_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm7.dat
gmx grompp -v -f ../eq.mdp -c pr_${i}.gro -p sys.top -o rec_eq_${i}.tpr -maxwarn 3 -n ../index.ndx -r ../em.gro 
gmx mdrun -deffnm rec_eq_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm7.dat
gmx grompp -v -f ../prod_1000ns_w.mdp -c rec_eq_${i}.gro -p sys.top -o fm_1000ns_${i}.tpr -maxwarn 3 -n ../index.ndx -r ../em.gro 
gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm7.dat  
