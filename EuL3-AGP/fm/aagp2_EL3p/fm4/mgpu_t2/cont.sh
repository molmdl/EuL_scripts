#!/bin/bash
#SBATCH --job-name=Fnl_aagp2_400ns
#SBATCH --nodes=1            
#SBATCH --ntasks=1
...
#gmx mdrun -deffnm pr_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm4.dat
#gmx grompp -v -f ../eq.mdp -c pr_${i}.gro -p sys.top -o rec_eq_${i}.tpr -maxwarn 3 -n ../index.ndx
#gmx mdrun -deffnm rec_eq_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm4.dat
#gmx grompp -v -f ../prod_400ns.mdp -c rec_eq_${i}.gro -p sys.top -o fm_400ns_${i}.tpr -maxwarn 3 -n ../index.ndx 
gmx mdrun -deffnm fm_400ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm4_ext.dat -cpi fm_400ns_${i}.cpt
