...
#gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 2 -plumed ../../aagp2_fm6_ext.dat -cpi fm_1000ns_${i}.cpt -nsteps 20000
#gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 2 -plumed ../../aagp2_fm6_ext.dat -cpi fm_1000ns_${i}.cpt -nsteps 20000
#gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 2 -plumed ../../aagp2_fm6_ext.dat -cpi fm_1000ns_${i}.cpt -nsteps 20000
#gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 2 -plumed ../../aagp2_fm6_ext.dat -cpi fm_1000ns_${i}.cpt -nsteps 20000
#gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 2 -plumed ../../aagp2_fm6_ext.dat -cpi fm_1000ns_${i}.cpt -nsteps 20000
#rm \#fm_1000ns_${i}.gro.* fm_1000ns_${i}.gro
gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 2 -plumed ../../aagp2_fm6_ext.dat -cpi fm_1000ns_${i}.cpt
