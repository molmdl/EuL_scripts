...
gmx mdrun -deffnm pr_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm6.dat
gmx grompp -v -f ../eq.mdp -c pr_${i}.gro -p sys.top -o rec_eq_${i}.tpr -maxwarn 3 -n ../index.ndx
gmx mdrun -deffnm rec_eq_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm6.dat
gmx grompp -v -f ../prod_1000ns.mdp -c rec_eq_${i}.gro -p sys.top -o fm_1000ns_${i}.tpr -maxwarn 3 -n ../index.ndx 
gmx mdrun -deffnm fm_1000ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp2_fm6.dat  
