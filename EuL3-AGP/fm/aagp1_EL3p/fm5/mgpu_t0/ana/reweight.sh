...
mpirun -np 16 plumed driver --mf_xtc ../fm_1000ns_0.xtc --plumed reweight.dat --mc mcfile --kt 2.494339 --trajectory-stride 20 >> plumed_reweight.log 2>> plumed_reweight.log
