#!/bin/bash
#SBATCH --job-name=fm7_AGP1_1.2us
#SBATCH --nodes=1            
#SBATCH --ntasks=1
...
gmx mdrun -deffnm fm_1200ns_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../../aagp1_fm7_ext.dat  -cpi fm_1000ns_${i}.cpt -noappend
