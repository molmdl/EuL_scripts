...
gmx mdrun -deffnm pr_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../metad_E64.dat
gmx grompp -v -f ../../eq.mdp -c pr_${i}.gro -p ../sys.top -o metad_eq_${i}.tpr -maxwarn 3 -n ../index.ndx -r ../em.gro 
gmx mdrun -deffnm metad_eq_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../metad_E64.dat
gmx grompp -v -f ../../prod_500ns.mdp -c metad_eq_${i}.gro -p ../sys.top -o metad_${i}.tpr -maxwarn 3 -n ../index.ndx -r ../em.gro 
gmx mdrun -deffnm metad_${i} -ntomp 22 -bonded gpu -nb gpu -update cpu -cpt 5 -plumed ../metad_E64.dat  
